...
export default function AddBookModal({ onClose }) {
  ...
  const createBook = useMutation({
    ...
    onError: (e) => {
      ...
      let errorMessage = "Помилка при додаванні";
      try {
    ...
    <div className={styles.overlay} onClick={onClose}>
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        <div className={styles.header}>
          <h2 className={styles.title}>Додати книгу</h2>
        ...
        <form className={styles.form} onSubmit={handleSubmit}>
          ...
          <label className={styles.checkboxLabel}>
            ...
            />
            <span>
              Доступна для обміну <RefreshCw className={styles.toggleIcon} />
            </span>
          </label>
          ...
          <div className={styles.actions}>
            ...
            >
              {createBook.isPending ? "Збереження..." : "Додати книгу"}
            </button>
          </div>
        </form>
      </div>
