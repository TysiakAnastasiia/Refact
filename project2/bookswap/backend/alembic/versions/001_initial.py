...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "language", sa.String(50), nullable=False, server_default="Ukrainian"
        ),
        sa.Column(
            "condition",
    ...
    op.create_table(
        ...
        sa.Column("owner_id", sa.Integer(), sa.ForeignKey("users.id"), nullable=False),
        sa.Column(
            "offered_book_id", sa.Integer(), sa.ForeignKey("books.id"), nullable=False
        ),
        sa.Column(
            "requested_book_id", sa.Integer(), sa.ForeignKey("books.id"), nullable=False
        ),
        sa.Column(
            "status",
            sa.Enum(
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column(
            "exchange_id", sa.Integer(), sa.ForeignKey("exchanges.id"), nullable=False
        ),
